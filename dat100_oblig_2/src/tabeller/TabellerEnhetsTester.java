...
class TabellerEnhetsTester {
    ...
    @Test
    void testSummerForOf() {
        assertEquals(11, Tabeller.summerForOf(tabell1));
        assertEquals(1, Tabeller.summerForOf(tabell2));
        assertEquals(0, Tabeller.summerForOf(tabell3));
    }
